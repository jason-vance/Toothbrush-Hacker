//
//  BlePeripheralCommunicator_Published.swift
//  Toothbrush Hacker
//
...
actor BlePeripheralCommunicator_Published: NSObject {
    
    private static var communicators: [CBPeripheral:BlePeripheralCommunicator_Published] = [:]
    
    static func getOrCreate(from peripheral: CBPeripheral) -> BlePeripheralCommunicator_Published {
        if !communicators.keys.contains(peripheral) {
            let communicator = BlePeripheralCommunicator_Published(
...
extension BlePeripheralCommunicator_Published: CBPeripheralDelegate {
